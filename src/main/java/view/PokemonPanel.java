...
public class PokemonPanel extends BasePanel {
    ...
    public void setPokemon(final PokemonWithLife pokemonWithLife){
        ...
        pokemonAttacks[0].setFont(new Font("Verdana",Font.PLAIN,Settings.Constants$.MODULE$.FRAME_SIDE()/45));
        ...
        pokemonAttacks[1].setFont(new Font("Verdana",Font.PLAIN,Settings.Constants$.MODULE$.FRAME_SIDE()/45));
        ...
        pokemonAttacks[2].setFont(new Font("Verdana",Font.PLAIN,Settings.Constants$.MODULE$.FRAME_SIDE()/45));
        ...
        pokemonAttacks[3].setFont(new Font("Verdana",Font.PLAIN,Settings.Constants$.MODULE$.FRAME_SIDE()/45));
